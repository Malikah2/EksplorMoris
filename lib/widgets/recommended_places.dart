...
class RecommendedPlaces extends StatelessWidget {
  ...
  final List<TouristPlace> TouristDetailsPageDolpins = [
    TouristPlace(
      ...
      price: 'Rs 600',
      latitude: -20.460157970812244,
      longitude:  57.31920969366907,
      rating: '4.5',
      duration: '7 hours',
    ...
    TouristPlace(
      ...
      price: 'Rs 450',
      latitude: -20.316381152514353,
      longitude: 57.511858226784376,
      rating: '4',
      duration: 'Full Day',
  ...
  final List<TouristPlace> TouristDetailsPageCatamaran = [
    ...
    TouristPlace(
      ...
      subtitle: 'As From Rs500 per adult',
      description:
          'Explore Ilot Gabriel via a catamaran cruise on this 7-hour tour from Grand Baie. Make swimming and snorkeling spots along the way, then drop anchor to explore the island before eating a barbecue lunch and sipping drinks from an open bar.',
      price: 'Rs 450',
      latitude: -19.885850008031703,
      longitude: 57.67241832995379,
      rating: '4.9',
      duration: '8 hours',
    ...
    TouristPlace(
      ...
      price: 'Rs 350',
      latitude: -20.15937430473295,
      longitude: 57.5080769516445,
      rating: '4',
      duration: '4-5 hours',
    ...
    TouristPlace(
      ...
      name:
          'Catamaran Cruise to Ile Aux Benitiers: Dolphin watch, Crystal Rock & Transfer',
      subtitle: 'As From Rs500 per adult',
      description:
      ...
      price: 'Rs 500',
      latitude: -20.420163451147342,
      longitude:  57.34418812366046,
      rating: '4.6',
      duration: 'Full Day',
    ...
    TouristPlace(
      ...
      subtitle: 'As From Rs500 per adult',
      description:
          'Instead of making separate plans for some of Mauritius\' top attractions, opt for a combo tour. Hike Ile aux Aigrettes nature reserve, the place to see giant tortoise; enjoy leisure time at Blue Bay\'s beach and lagoon. You can also visit the National History Museum (Naval Museum).',
      price: 'Rs 750',
      latitude: -20.419773667711905,
      longitude:  57.732784135883726,
      rating: '4.5',
      duration: 'Full Day',
  ...
  final List<TouristPlace> TouristDetailsPageQuad = [
    TouristPlace(
      ...
      subtitle: 'As From Rs500 per adult',
      description:
          'Embrace the freedom to create your own La Vallée des Couleurs adventure just the way you want it! With our customizable day package, the power is in your hands to design an experience that perfectly suits your preferences and desires.',
      price: 'Rs 500',
      latitude: -20.45746319828413,
      longitude: 57.4851672663141,
      rating: '4.5',
      duration: '2 hours',
  ...
  final List<TouristPlace> TouristDetailsPageHiking = [
    TouristPlace(
      ...
      price: 'Rs 250',
      latitude: -20.470860056286114,
      longitude: 57.341660160310255,
      rating: '4.4',
      duration: 'Half Day',
    ...
    TouristPlace(
      ...
      price: 'Rs 300',
      latitude: -20.43741630421167,
      longitude: 57.37392001049415,
      rating: '5',
      duration: 'Half Day',
  ...
  final List<TouristPlace> TouristDetailsPageHistorical = [
    ...
    TouristPlace(
      ...
      price: 'Rs 400',
      latitude: -20.427827839827803,
      longitude: 57.39637451049377,
      rating: '4',
      duration: '3 hours',
  ...
  final List<TouristPlace> TouristDetailsPageCasino = [
    ...
    TouristPlace(
      ...
      description:
          'Your first and only stop when it comes to Casinos in Mauritius. Senator Casino offers its customers a safe place to play their favourite Casino games: Slot Machines, Roulette, Van Lak, SicBo The have introduced the Ticket In/ Ticket Out system in the innovative gaming world of Mauritius. The bar has a very reasonable food and drinks in a very laid back atmosphere and is provided free of charge to customers.',
      price: '-',
      latitude: -20.1603423151225,
      longitude: 57.4996924633496,
      rating: '4.5',
      duration: '-',
  ...
  final List<TouristPlace> TouristDetailsPageWaterfall = [
    TouristPlace(
      ...
      description:
          'Marvel at the glorious nature on offer in Mauritius during this half-day hiking tour through the Seven Cascades of the Tamarind Falls. Led by an experienced guide, travel through lush forests and over dark volcanic rocks. From the top of the falls, admire stunning views over the surrounding canyons. Then, cool off with a swim in the pool and enjoy a natural water massage.',
      price: 'Rs 300',
      latitude: -20.343743057106284,
      longitude: 57.46636115430987,
      rating: '4.7',
      duration: '4 hours',
    ...
    TouristPlace(
      ...
      price: 'Rs 300',
      latitude: -20.442990517233305,
      longitude: 57.38582158703086,
      rating: '4.4',
      duration: '3 hours',
    ...
    TouristPlace(
      ...
      description: '',
      price: 'Rs 300',
      latitude: -20.502792545965832,
      longitude: 57.516839523988075,
      rating: '4.6',
      duration: '3 hours',
    ...
    TouristPlace(
      ...
      description: '',
      price: 'Rs 300',
      latitude: -20.433552810539513,
      longitude: 57.45773972750367,
      rating: '4.8',
      duration: '3 hours',
    ...
    TouristPlace(
      ...
      description: '',
      price: 'Rs 300',
      latitude: -20.440216528065893,
      longitude: 57.45824499700264,
      rating: '5',
      duration: '3 hours',
  ...
  List<TouristPlace> combineAllPlaces() {
    return [
      ...
      ...TouristDetailsPageNature,
      ...TouristDetailsPageCatamaran,
      ...TouristDetailsPageQuad,
      ...TouristDetailsPageHiking,
      ...TouristDetailsPageHistorical,
      ...TouristDetailsPageCasino,
                ...
                onTap: () {
                  if (index == 0) {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            TouristDetailsPage(places: TouristDetailsPageQuad),
                      ),
                    );
                  } else if (index == 4) {
                    Navigator.push(
